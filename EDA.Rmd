...
colname[outers]
```
# 1.1.6 Low variance Filter and correlation of our numeric attributes, outlier handling and Feature engineering
...
ggplot(data = temp, aes(x=temp$ExterQual, y=temp$SalePrice)) + geom_count(aes(fill = factor(temp$ExterQual) )) 
ggplot(data = temp, aes(x=temp$KitchenQual, y=temp$SalePrice)) + geom_count(aes(fill = factor(temp$KitchenQual) )) 
ggplot(data = temp, aes(x=temp$BsmtQual, y=temp$SalePrice)) + geom_count(aes(fill = factor(temp$BsmtQual) ))
ggplot(data = temp, aes(x=temp$FireplaceQu, y=temp$SalePrice)) + geom_count(aes(fill = factor(temp$FireplaceQu) ))
ggplot(data = temp, aes(x=temp$Fireplace, y=temp$SalePrice)) + geom_count(aes(fill = (temp$Fireplace) ))
ggplot(data = temp, aes(x=temp$PoolArea, y=temp$SalePrice)) + geom_count(aes(fill = (temp$PoolArea) ))
ggplot(data = temp, aes(x=temp$MiscVal, y=temp$SalePrice)) + geom_count(aes(fill = (temp$MiscVal) ))
