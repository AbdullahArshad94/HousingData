...
MAE(data_test$SalePrice, tree_pred)
RMSE(data_test$SalePrice, tree_pred)
...
```
#3.3.2 Ridge, Lasso and elastic net regression
```{r}
set.seed(42)
...
results
# We favour more of the lasso technique with an alpha of 0.8
```
